                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12 infobank-list-app my-4">
                        <div class="col-12 py-4">
                            <form method="POST" action="<?= base_url() ?>swap/notif" onsubmit="return validate()" id="form_submit">
                                ...
                                <div class="col-12 list-send-wallet d-flex flex-column mb-3">
                                    <span>Recipient unique code</span>
                                    <span><?= $_SESSION['ucode'] ?></span>
                                    <input type="text" class="form-control mb-4" name="ucode" id="ucode" placeholder="Unique code" value="<?= $_SESSION['ucode'] ?>" hidden>
                                </div>
                                <div class="col-12 list-send-wallet d-flex flex-column mb-3">
                                    <span>Amount</span>
                                ...
                                <div class="col-12 d-flex flex-row mt-5">
                                    <a href="<?= base_url() ?>swap" class="btn btn-wallet-cancle py-2 me-auto">Cancel</a>
                                    <button class="btn btn-receive-bank px-5 py-2" id="btnconfirm" type="submit">OK</button>
                                </div>
                            </form>
                        </div>
                    </div>
