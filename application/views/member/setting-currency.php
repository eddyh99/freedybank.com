                ...
                <div class="col-12 back-btn-transaction my-4 text-start">
                    ...
                    <div class="col-12 px-0 px-lg-5 check-currency">
                            ...
                            <div class="d-flex flex-row align-items-center form-check form-switch my-2">
                                ...
                                <input class="form-check-input pill-currency" type="checkbox" id="aeddirham" <?php echo ($dt->status=='active') ? "checked":"" ?> onclick="enablecurrency('<?=$dt->currency?>','<?php echo ($dt->status=='active')?"disabled":"active"?>')">
                            </div>
                            <?php  
                                  }}
                            ?>
