                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12 infobank-list-app my-4">
                        <div class="py-4">
                            ...
                            <form method="POST" action="<?= base_url() ?>wallet/send_confirm" class="text-center" id="form_submit" onsubmit="return validate()">
                                <input type="hidden" id="token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <input type="text" class="form-control my-4" name="ucode" id="ucode" placeholder="Unique code" value="<?= @$ucode ?>" <?php echo (empty($ucode) ? "" : "readonly") ?>>
                                ...
                                <input type="text" class="form-control my-4" placeholder="Causal" name="causal" maxlength="10">
