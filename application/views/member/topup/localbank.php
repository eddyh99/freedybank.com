                    ...
                    <div class="col-12 infobank-list-app my-4">
                        <div class="py-4">
                            ...
                            <div class="row">
                                <label>Transit</label>
                                <div class="d-flex flex-row align-items-center mb-3">
                                    <input class="form-control me-2" type="text" name="transit_circuit" id="inter3"
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex flex-row align-items-center mb-3">
                                    <input class="form-control me-2" type="text" name="" id="us2"
                                        placeholder="Routing Number" value="<?= @$bank->number_circuit ?>" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex flex-row align-items-center mb-3">
                                    <input class="form-control me-2" type="text" name="" id="us3"
                                        placeholder="Account Number" value="<?= @$bank->routing_circuit ?>" readonly>
                            ...
                            <div class="row">
                                <label>Transit</label>
                                <div class="d-flex flex-row align-items-center mb-3">
                                    <input class="form-control me-2" type="text" name="" id="us5" placeholder="Causal"
                                        value="<?= @$bank->transit_circuit ?>" readonly>
