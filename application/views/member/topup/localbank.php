                    ...
                    <div class="col-12 infobank-list-app my-4">
                        <div class="py-4">
                            ...
                            ?>
                                ...
                                <?php if ($_SESSION["currency"]!="NZD" && $_SESSION["currency"]!="HUF" && $_SESSION["currency"]!="TRY"){?>
                                    <div class="row">
                                        <?php
                                        ...
                                        <?php } elseif ($_SESSION["currency"]=="CAD") {?>
                                                <label class="form-label">Instituion Number</label>
                                        <?php } elseif ($_SESSION["currency"]=="RON") {?>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-3">
                                            <input class="form-control me-2" type="text" name="" id="us3"
                                                placeholder="Swift" value="<?= @$bank->routing_circuit ?>" readonly>
                                ...
                                <?php if ($_SESSION["currency"]=="GBP" || $_SESSION["currency"]=="CAD"){?>
                                    ...
                                    <?php }?>
                                    <div class="d-flex flex-row align-items-center mb-3">
                                        <input class="form-control me-2" type="text" name="" id="us5" placeholder="Transit Number"
