<div class="row">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <p>
                    ...
                    Open your <b translate="no"> FreedyBank </b> account and add funds to your account (by bank
                    transfer,
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="col-12 mb-5">
                    ...
                    <p>
                        <b translate="no"> FreedyBank </b> has no top-up limits, but you must comply with the cash laws
                        in
    ...
    <div class="col-12 mb-5">
        <div class="col-12 text-center">
            <h2 class="title-accordion-freedy mb-3 fw-bold">Where can I top up / cashout <b translate="no"> FreedyBank
                </b> account?</h2>
            <p>
            ...
            <div>
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <h4 class="text-blue-freedy link-lp fw-bold f-lexend mb-3">Become a <b translate="no"> Freedy
                            </b>
                            fast point</h4>
