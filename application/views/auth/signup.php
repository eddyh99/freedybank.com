        ...
        <div class="row d-flex d-lg-inline-grid justify-content-center justify-content-lg-start">
            <div class="col-10 col-sm-8 col-md-6 col-lg-5 box-form">
                <form class="form-login-freedy d-flex align-items-start flex-column" style="height: 100%;" method="POST"
                    action="<?= base_url(); ?>auth/signup_notif">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control f-publicsans" id="email" placeholder="">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control f-publicsans" id="password1" placeholder="">
                            <div class="input-group-text">
                                <span>
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control f-publicsans" id="password2" placeholder="">
                            <div class="input-group-text">
                                <span>
                    ...
                    <div class="col-12 mb-5">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control f-publicsans py-2" id="email" placeholder="">
                        </div>
                    </div>
